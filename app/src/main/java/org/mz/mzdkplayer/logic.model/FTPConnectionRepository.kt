...
class FTPConnectionRepository(private val context: Context) {
    ...
    private val prefs: SharedPreferences =
        context.getSharedPreferences("ftp_connections_prefs", Context.MODE_PRIVATE)
    private val gson = Gson()
    private val connectionListType = object : TypeToken<List<FTPConnection>>() {}.type
     ...
     */
    fun saveConnections(connections: List<FTPConnection>) {
        prefs.edit {
     ...
     */
    fun getConnections(): List<FTPConnection> {
